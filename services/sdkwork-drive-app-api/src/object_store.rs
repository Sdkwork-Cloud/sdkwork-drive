...
use sdkwork_drive_product::application::download_service::DriveDownloadService;
...
impl AppDownloadSigner {
    ...
    ) -> Result<SignedUploadPartPayload, DriveProductError> {
        let provider =
...
pub(crate) fn require_active_storage_provider(
    ...
    bucket: &str,
) -> Result<ActiveStorageProviderRecord, DriveProductError> {
...
fn get_bool(row: &sqlx::any::AnyRow, column: &str) -> Result<bool, DriveProductError> {
