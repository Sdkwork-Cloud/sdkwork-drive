...
This directory is the local SDKWork component contract for `sdkwork-drive-admin-storage-api`.

- Component root: `sdkwork-drive/services/sdkwork-drive-admin-storage-api`
