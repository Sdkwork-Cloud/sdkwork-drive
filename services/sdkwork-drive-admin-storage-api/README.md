...
Domain: drive
Capability: admin-storage-api
Package type: web-backend-service
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-drive-admin-storage-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
