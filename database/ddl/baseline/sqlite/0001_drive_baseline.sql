-- SDKWork drive consolidated initialization baseline (sqlite)
-- Generated from crates/sdkwork-drive-workspace-service/src/infrastructure/sql/sqlite_core.sql
-- Application baseline mirrors runtime installer authority for SQLite types and indexes.
...
-- folded migration: migrations/sqlite/0007_drive_sandbox_workspace.up.sql
