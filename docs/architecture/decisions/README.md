...
New ADRs use `ADR-YYYYMMDD-<short-title>.md` in this directory per `ARCHITECTURE_DECISION_SPEC.md`.
...
See `../../sdkwork-specs/ARCHITECTURE_DECISION_SPEC.md` and `../../sdkwork-specs/DOCUMENTATION_SPEC.md` section 2.3.
