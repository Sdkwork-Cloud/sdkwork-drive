...
- `D:\javasource\spring-ai-plus\spring-ai-plus-business\specs\SECURITY_SPEC.md`
- `D:\javasource\spring-ai-plus\spring-ai-plus-business\specs\PERFORMANCE_SPEC.md`
- `D:\javasource\spring-ai-plus\spring-ai-plus-business\specs\OBSERVABILITY_SPEC.md`
- `D:\javasource\spring-ai-plus\spring-ai-plus-business\specs\IAM_SPEC.md`
...
- `services/sdkwork-drive-admin-api` exposes admin/operator `/backend/v3/api`.
...
- `DriveSpace`: a top-level storage space, such as personal drive, team drive, knowledge-base drive, AI-generated assets, or app upload storage.
...
`drive_storage_object` is the database fact for physical bytes. It records provider identity, bucket, object key, size, checksums, encryption reference, storage class, and lifecycle status.
...
3. Service creates `drive_upload_session`.
...
8. Service commits `drive_storage_object`, `drive_file_version`, `drive_node`, `drive_change_log`, `drive_audit_event`.
...
- `uk_drive_space_uuid`
- `idx_drive_space_tenant_type_status`
- `idx_drive_space_tenant_owner`
...
- `uk_drive_knowledge_space_profile_space`
- `idx_drive_knowledge_space_profile_kb`
...
- `uk_drive_ai_generation_space_profile_space`
- `idx_drive_ai_generation_space_profile_app`
...
- `uk_drive_app_upload_space_profile_space`
- `idx_drive_app_upload_space_profile_app`
...
- `idx_drive_node_tenant_space_parent_status_name`
- `idx_drive_node_tenant_space_updated`
- `idx_drive_node_tenant_owner_updated`
...
- `uk_drive_storage_object_provider_key`
- `idx_drive_storage_object_tenant_hash_size`
- `idx_drive_storage_object_tenant_status_updated`
...
- `uk_drive_upload_session_uuid`
- `uk_drive_upload_session_idempotency`
- `idx_drive_upload_session_tenant_state_expires`
...
- `idx_drive_permission_resource`
- `idx_drive_permission_subject`
...
- `uk_drive_share_link_token_hash`
- `idx_drive_share_link_resource`
...
- `uk_drive_change_log_space_sequence`
- `idx_drive_change_log_resource`
...
- `idx_drive_audit_event_tenant_created`
- `idx_drive_audit_event_resource`
...
```text
openapi/
  drive-app-sdk.openapi.json
  drive-app-sdk.sdkgen.json
drive-app-sdk-typescript/
drive-app-sdk-rust/
drive-app-sdk-java/
drive-app-sdk-python/
drive-app-sdk-go/
...
bin/
  generate-sdk.mjs
...
- Space types include `personal`, `team`, `knowledge_base`, `ai_generated`, and `app_upload`.
