...
from ..models import CreateLabelRequest, DeleteLabelResponse, DriveLabel, LabelListResponse, UpdateLabelRequest
...
class LabelsApi:
    ...
    def create(self, body: CreateLabelRequest) -> DriveLabel:
