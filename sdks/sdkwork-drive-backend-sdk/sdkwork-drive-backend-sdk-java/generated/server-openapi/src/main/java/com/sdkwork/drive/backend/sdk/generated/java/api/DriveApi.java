...
public class DriveApi {
    ...
    public StorageProviderBinding storageProviderBindingsDefaultSet(SetDefaultStorageProviderBindingRequest body) throws Exception {
        Object raw = client.put(ApiPaths.backendPath("/drive/storage_provider_bindings/default"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<StorageProviderBinding>() {});
    }
    ...
    public ListStorageProvidersResponse storageProvidersList(String status) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/drive/storage_providers"), query));
    ...
    public StorageProvider storageProvidersCreate(CreateStorageProviderRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers"), body, null, null, "application/json");
    ...
    public StorageProvider storageProvidersUpdate(String providerId, UpdateStorageProviderRequest body) throws Exception {
        Object raw = client.patch(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<StorageProvider>() {});
    }
    ...
    public DeleteStorageProviderResponse storageProvidersDelete(String providerId, String operatorId) throws Exception {
        ...
        Object raw = client.delete(ApiPaths.appendQueryString(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + ""), query));
    ...
    public StorageProvider storageProvidersGet(String providerId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<StorageProvider>() {});
    }

    public StorageProvider storageProvidersActivate(String providerId, OperatorRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/activate"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<StorageProvider>() {});
    }

    public StorageProviderCapabilities storageProvidersCapabilitiesGet(String providerId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/capabilities"));
    ...
    public StorageProvider storageProvidersCredentialsRotate(String providerId, RotateStorageProviderCredentialRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/credentials/rotate"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<StorageProvider>() {});
    }

    public StorageProvider storageProvidersDeactivate(String providerId, OperatorRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/deactivate"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<StorageProvider>() {});
    }
    ...
    public TestStorageProviderResponse storageProvidersTest(String providerId, TestStorageProviderRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/test"), body, null, null, "application/json");
    ...
    public ProviderBucket storageProvidersBucketHead(String providerId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/bucket"));
        return client.convertValue(raw, new TypeReference<ProviderBucket>() {});
    }

    public ProviderBucketMutation storageProvidersBucketCreate(String providerId) throws Exception {
        Object raw = client.put(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/bucket"), null);
        return client.convertValue(raw, new TypeReference<ProviderBucketMutation>() {});
    }

    public ProviderBucketMutation storageProvidersBucketDelete(String providerId) throws Exception {
        Object raw = client.delete(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/bucket"));
        return client.convertValue(raw, new TypeReference<ProviderBucketMutation>() {});
    }
    ...
    public ProviderObjectList storageProvidersObjectsList(String providerId, String prefix, String delimiter, String pageToken, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/objects"), query));
    ...
    public ProviderObject storageProvidersObjectsHead(String providerId, String objectKey) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/objects/" + serializePathParameter(objectKey, new PathParameterSpec("objectKey", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<ProviderObject>() {});
    }

    public ProviderObjectMutation storageProvidersObjectsDelete(String providerId, String objectKey) throws Exception {
        Object raw = client.delete(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/objects/" + serializePathParameter(objectKey, new PathParameterSpec("objectKey", "simple", false)) + ""));
    ...
    public ProviderObjectMutation storageProvidersObjectsCopy(String providerId, CopyProviderObjectRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/drive/storage_providers/" + serializePathParameter(providerId, new PathParameterSpec("providerId", "simple", false)) + "/objects/copy"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<ProviderObjectMutation>() {});
    }
