...
use crate::models::{CreateLabelRequest, DriveLabel, UpdateLabelRequest};
...
impl LabelsApi {
    ...
    pub async fn list(&self, lifecycle_status: Option<&str>, page_size: Option<i64>, cursor: Option<&str>) -> Result<serde_json::Value, SdkworkError> {
    ...
    pub async fn retrieve(&self, label_id: &str) -> Result<serde_json::Value, SdkworkError> {
    ...
    pub async fn update(&self, label_id: &str, body: &UpdateLabelRequest) -> Result<serde_json::Value, SdkworkError> {
        let path = backend_path(&format!("/drive/labels/{}", serialize_path_parameter(label_id, PathParameterSpec::new("labelId", "simple", false))));
        self.client.patch(&path, Some(body), None, None, Some("application/json")).await
    }

    /// Delete a Drive label definition
    pub async fn delete(&self, label_id: &str) -> Result<(), SdkworkError> {
        let path = backend_path(&format!("/drive/labels/{}", serialize_path_parameter(label_id, PathParameterSpec::new("labelId", "simple", false))));
