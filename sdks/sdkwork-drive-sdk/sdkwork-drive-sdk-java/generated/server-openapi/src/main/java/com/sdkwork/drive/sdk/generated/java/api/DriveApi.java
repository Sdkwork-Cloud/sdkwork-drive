...
public class DriveApi {
    ...
    public DriveOpenShareLink openShareLinksResolve(String token) throws Exception {
        Object raw = client.get(ApiPaths.customPath("/drive/share_links/" + serializePathParameter(token, new PathParameterSpec("token", "simple", false)) + ""));
        return client.convertValue(raw, new TypeReference<DriveOpenShareLink>() {});
    }

    public OpenDownloadUrlResponse openShareLinksDownloadUrlsCreate(String token, CreateOpenDownloadUrlRequest body) throws Exception {
        Object raw = client.post(ApiPaths.customPath("/drive/share_links/" + serializePathParameter(token, new PathParameterSpec("token", "simple", false)) + "/download_url"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<OpenDownloadUrlResponse>() {});
    }
