...
impl DriveApi {
    ...
    pub async fn open_share_links_resolve(&self, token: &str) -> Result<DriveOpenShareLink, SdkworkError> {
        let path = custom_path(&format!("/drive/share_links/{}", serialize_path_parameter(token, PathParameterSpec::new("token", "simple", false))));
