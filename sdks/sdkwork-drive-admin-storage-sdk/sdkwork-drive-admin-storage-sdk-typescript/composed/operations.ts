...
export const operations = {
  ...
  "storageProviderBindings.default.get": { method: "GET", path: "/backend/v3/api/drive/storage/bindings/default" },
  "storageProviderBindings.default.set": { method: "PUT", path: "/backend/v3/api/drive/storage/bindings/default" },
  ...
  "storageProviders.bucket.create": { method: "PUT", path: "/backend/v3/api/drive/storage/providers/{providerId}/bucket" },
  "storageProviders.bucket.delete": { method: "DELETE", path: "/backend/v3/api/drive/storage/providers/{providerId}/bucket" },
  "storageProviders.bucket.head": { method: "GET", path: "/backend/v3/api/drive/storage/providers/{providerId}/bucket" },
  "storageProviders.buckets.list": { method: "GET", path: "/backend/v3/api/drive/storage/providers/{providerId}/buckets" },
  "storageProviders.capabilities.get": { method: "GET", path: "/backend/v3/api/drive/storage/providers/{providerId}/capabilities" },
  ...
  "storageProviders.get": { method: "GET", path: "/backend/v3/api/drive/storage/providers/{providerId}" },
  ...
  "storageProviders.objects.head": { method: "GET", path: "/backend/v3/api/drive/storage/providers/{providerId}/objects/{objectKey}" },
