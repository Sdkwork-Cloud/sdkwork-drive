...
impl NodeLabelsApi {
    ...
    pub async fn list(&self, node_id: &str, label_key: Option<&str>, page_size: Option<i64>, cursor: Option<&str>) -> Result<serde_json::Value, SdkworkError> {
    ...
    pub async fn update(&self, node_id: &str, label_id: &str, body: &ApplyNodeLabelRequest) -> Result<NodeLabel, SdkworkError> {
