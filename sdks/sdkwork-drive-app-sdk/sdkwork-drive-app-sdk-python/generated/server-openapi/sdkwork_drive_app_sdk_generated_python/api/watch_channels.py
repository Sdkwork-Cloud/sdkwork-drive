...
from ..models import CreateWatchChannelRequest, DriveWatchChannel, DriveWatchChannelListResponse, StopWatchChannelRequest, StopWatchChannelResponse
...
class WatchChannelsApi:
    """watch_channels watch_channels API client."""

    def __init__(self, client: HttpClient):
        self._client = client
        self.changes = WatchChannelsChangesApi(client)
...
class WatchChannelsChangesApi:
    """watch_channels watch_channels.changes API client."""

    def __init__(self, client: HttpClient):
        self._client = client


    def watch(self, body: CreateWatchChannelRequest) -> DriveWatchChannel:
...
class WatchChannelsNodesApi:
    """watch_channels watch_channels.nodes API client."""

    def __init__(self, client: HttpClient):
        self._client = client


    def watch(self, node_id: str, body: CreateWatchChannelRequest) -> DriveWatchChannel:
