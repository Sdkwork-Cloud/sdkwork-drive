...
- `crates/sdkwork-router-drive-app-api/src/main.rs`: app-api server binary
- `crates/sdkwork-router-drive-backend-api/src/main.rs`: backend-api server binary
- `crates/sdkwork-router-drive-open-api/src/main.rs`: open-api server binary
- `crates/sdkwork-router-storage-backend-api/src/main.rs`: storage backend-api server binary
