...
pub mod events {
    pub const ADMIN_AUDIT_EVENTS_LIST: &str = "drive.audit_events.list";
    pub const ADMIN_MAINTENANCE_JOBS_LIST: &str = "drive.maintenance.jobs.list";
    pub const ADMIN_MAINTENANCE_OBJECT_SWEEP: &str = "drive.maintenance.object_sweep";
    pub const ADMIN_MAINTENANCE_UPLOAD_SESSION_SWEEP: &str =
