...
This directory is the local SDKWork component contract for `sdkwork-router-drive-open-api`.

- Component root: `sdkwork-drive/crates/sdkwork-router-drive-open-api`
