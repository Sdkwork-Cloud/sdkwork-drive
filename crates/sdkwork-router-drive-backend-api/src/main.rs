...
use sdkwork_router_drive_backend_api::build_router_with_database_config;

#[tokio::main]
async fn main() {
    sdkwork_drive_observability::init_tracing("sdkwork-router-drive-backend-api");
    ...
    serve_router(router, bind_addr, "sdkwork-router-drive-backend-api")
        .await
